...
- **The next real step in this milestone is the one gap left** — the live streaming driver — plus the
  daemon wiring that turns `approval.ask_via` into a running receive loop, not another platform.
