...
1478 tests, 0 failed                     # includes 25 chat API tests and 4 database reopen tests
...
```bash
cargo test --workspace --locked   # 1478 tests, 0 failed, 60 ignored live tests
...
- **13 crates with logic**: unit-tested at the level of pure functions and in-process lifecycles. There
  ...
  (A 14th, `hx-desktop`, carries 25 tests for its endpoint/token resolution and bundle reuse.)
