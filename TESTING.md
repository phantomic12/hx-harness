...
1536 tests, 0 failed                     # includes 25 chat API tests and 4 database reopen tests
...
```bash
cargo test --workspace --locked   # 1536 tests, 0 failed, 60 ignored live tests
