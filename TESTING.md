...
978 tests, 0 failed                      # includes 24 chat API tests and 4 database reopen tests
...
# terminal_remote_live; `canary.yml` runs search_live — 32 of the 52. The model suites need a key,
