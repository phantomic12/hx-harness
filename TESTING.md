...
999 tests, 0 failed                       # includes 20 chat API tests and 4 database reopen tests
56 ignored                               # live: Docker, SSH, search, a real model, a real bot
...
- **56 live tests**, all `#[ignore]`d by default: a real Docker daemon with gVisor installed, a real
  `sshd`, a real SearXNG and a real bot are run in CI or deliberately; the four against a real model and
  the four against a real bot are run deliberately, since they need a key and CI has none.
